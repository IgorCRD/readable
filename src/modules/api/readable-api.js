...
class ReadableAPIWrapper {
  ...
  getAllCategories = () => fetch(`${this.apiURL}/categories`, {
  ...
  getPostsByCategory = (category) => {
    const { path } = typeof category === 'string' || category instanceof String ? { path: category } : category;
  ...
  getAllPosts = () => fetch(`${this.apiURL}/posts`, {
    headers: { ...this.headers },
  }).then(res => res.json());

  getPostById = id => fetch(`${this.apiURL}/posts/${id}`, {
    headers: { ...this.headers },
  }).then(res => res.json());
  ...
  votePost = (id, vote) => fetch(`${this.apiURL}/posts/${id}`, {
    headers: {
      ...this.headers,
      'content-type': 'application/json',
    },
  ...
  editPost = (id, editedPost) => fetch(`${this.apiURL}/posts/${id}`, {
    headers: {
      ...this.headers,
      'content-type': 'application/json',
    },
  ...
  deletePost = id => fetch(`${this.apiURL}/posts/${id}`, {
    headers: {
      ...this.headers,
    },
    method: 'DELETE',
  ...
  getAllComments = id => fetch(`${this.apiURL}/posts/${id}/comments`, {
    headers: {
      ...this.headers,
    },
  }).then(res => res.json());
  ...
  voteComment = (id, vote) => fetch(`${this.apiURL}/comments/${id}`, {
    headers: {
      ...this.headers,
      'content-type': 'application/json',
    },
  ...
  deleteComment = id => fetch(`${this.apiURL}/comments/${id}`, {
    headers: {
      ...this.headers,
    },
    method: 'DELETE',
  ...
  editComment = (id, editedComment) => fetch(`${this.apiURL}/comments/${id}`, {
    headers: {
      ...this.headers,
      'content-type': 'application/json',
    },
